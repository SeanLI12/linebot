...
const secret = "3358a43346501397b296b3175cf5280d"; // Channel Secret
const id = "1492048064"; // Channel ID
const mid = "kAq5LWLxIzspTc8nebU0/B4Q5n/K2xyRH+02Sz4g2KdTjVqheUTz9MB45TL9gmRLY5byFKFGzAYaTJXjjGumY73EjovCmk3EE39j3BhvidPanLzKVuZjPFGbaJhAQxGqHxwHs6KNLW5J1hEYN7RDugdB04t89/1O/w1cDnyilFU="; // MID 
  ...
  if(foo=="outright"){
    ...
    event.reply({
      ...
      template: {
          ...
          text: 'What About Phil T1aylor? How Will He Fare?',
          actions: [{
              type: 'postback',
              label: 'Round3 2.60',
